                ...
                for i4 = 1:n
                    ...
                    for i5 = 1:n
                      ...
                      for i6 = 1:n
                        ...
                        P6 = P5*eval(matrix6);
%                        P = eval(matrix1)*eval(matrix2)*eval(matrix3)*eval(matrix4)*eval(matrix5)*eval(matrix6);
                        if (P6(1,1) > winner) 
                          winner = P6(1,1);
                        end
                        if ((P6(1,1) >= winner) && (P6(1,1) >= cutoff))
                          fprintf('%3d, %3d, %3d %3d %3d %3d %s, %s, %s, %s, %s, %s, %f \n', ...
                                  ci1, ci2, ci3, ci4, ci5, ci6, ...
                                  an{ci1}, an{ci2}, an{ci3}, an{ci4}, ...
                                  an{ci5}, an{ci6}, P6(1,1));
                        end
                      end
                    end
                end
